...
[Route("Tabella/[action]")]
public class Tabella : Controller
{
    [PageAuthorize, HttpGet, Route("~/tabella")]
#if (Northwind)
    public ActionResult Index([FromServices] ITwoLevelCache cache, [FromServices] ISqlConnections sqlConnections)
    {
        ...
        var cachedModel = cache.GetLocalStoreOnly("TabellaModel", TimeSpan.FromMinutes(5),
            o.GenerationKey, () =>
            {
